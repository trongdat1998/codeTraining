...
import { InMemoryDataService } from './core/service/api-data/in-memory-data.service';
...
import { HeroSearchComponent } from './layout/components/hero-search/hero-search/hero-search.component'; // <-- NgModel lives here
@NgModule({
  declarations: [
    AppComponent,
    HeroesComponent,
